package fr.imtatlantique.projet23.web.dao.impl;
...
//                    data.setSpeedOverGnd(curLine[4].length() != 0 ? Double.valueOf(curLine[4]) : null);
                    ...
                    data.setTrueheading(curLine[6].length() != 0 ? Double.valueOf(curLine[6]) : null);
                    ...
                    data.setAirtemperature(curLine[12].length() != 0 ? Double.valueOf(curLine[12]) : null);
                    data.setAtmpressure(curLine[13].length() != 0 ? Double.valueOf(curLine[13]) : null);
                    ...
                    data.setO2(curLine[18].length() != 0 ? Double.valueOf(curLine[18]) : null);
                    dataList.add(data);
                } catch (Exception e) {
                    e.printStackTrace();
                }
